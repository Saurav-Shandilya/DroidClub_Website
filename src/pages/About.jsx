  ...
  return (
    <div className="bg-[#0f0f13] min-h-screen text-white pt-32 px-6 pb-20">
      ...
      <p className="text-gray-400 text-center max-w-2xl mx-auto mb-16"><i>
        A space where technology, creativity, leadership and innovation come together.</i>
      </p>
      ...
      <div className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          ...
          {[
            ...
            <div key={i} className="bg-[#1a1a24] rounded-xl p-5 border border-[#9D4EDD]/20 hover:border-[#9D4EDD] transition shadow-lg">
              <img src={p.img} className="rounded-xl mb-4 w-full h-52 object-cover shadow-md shadow-[#9D4EDD]/20" />
